...
class TableRepository implements Repository {
    ...
    // TODO: move filtered count to separate method
     ...
     *
     * @return \Webarticum\Core\Entity\ActiveRecordEntity
     */
     ...
     *
     * @param int $id
     * @return \Webarticum\Core\Entity\ActiveRecordEntity|null
     */
    ...
    /**
     * @param \Webarticum\Core\Database\ActiveRecord
     */
    ...
    /**
     * @param \Webarticum\Core\Database\ActiveRecord $oActiveRecord
     * @return \Webarticum\Core\Entity\ActiveRecordEntity
     */
