...
namespace Webarticum\Core\Database\QueryBuilderDriver\Mysql;

use Webarticum\Core\Database\Connection;
use Webarticum\Core\Database\AbstractQueryBuilder;
use Webarticum\Core\Database\QueryBuilder as QueryBuilderInterface;
use Webarticum\Core\Database\Filter;
use Webarticum\Core\Database\ResultSet;
...
class QueryBuilder extends AbstractQueryBuilder {
    ...
    /**
     * @param \Webarticum\Core\Database\Connection $oConnection
     */
