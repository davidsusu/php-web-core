...
class ConnectionManager {
    ...
    static protected $connectionClassMap = [
        "pdo" => "Webarticum\\Core\\Database\\ConnectionDriver\\Pdo\\Connection",
    ];
    
    static protected $platformClassMap = [
        "mysql" => "Webarticum\\Core\\Database\\PlatformDriver\\Mysql\\Platform",
    ];
    
    static protected $queryBuilderClassMap = [
        "mysql" => "Webarticum\\Core\\Database\\QueryBuilderDriver\\Mysql\\QueryBuilder",
    ];
     ...
     * @param string $uri
     * @param string $name
     * @return \Webarticum\Core\Database\Connection
     */
