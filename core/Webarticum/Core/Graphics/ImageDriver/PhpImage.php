...
use Webarticum\Core\Graphics\Misc\Charmap;
use Webarticum\Core\Graphics\Misc\PhpImageIo;
...
class PhpImage extends AbstractImage {
     ...
     * @return self
     */
    public function loadFromContent($file, $type = null) {
        
        // TODO
        throw new \Exception("loadFromContent is not supported");
    }
    ...
    public function cloneFrom(Image $oImage) {
        ...
        if ($oImage instanceof self) {
            ...
            $copied = @copy($oldres['file'],$newfile);
            if (!$copied) {
            ...
            case Image::EFFECT_GAMMA:
                for ($y = 0; $y < $vmax; $y++) {
                    for ($x = 0; $x < $hmax; $x++) {
                        ...
                        $oNewColor = $oColor->gamma($params["power"]);
