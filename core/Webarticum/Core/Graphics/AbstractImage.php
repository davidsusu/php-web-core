...
namespace Webarticum\Core\Graphics;
...
abstract class AbstractImage implements Image {
    ...
    protected function _clone_properties_from(Image $oImage) {
        if ($oImage instanceof AbstractImage) {
            $this->errorMode = $oImage->errorMode;
            $this->font = $oImage->font;
            $this->fontSize = $oImage->fontSize;
            $this->color = $oImage->color;
            $this->fillColor = $oImage->fillColor;
            $this->behindColor = $oImage->behindColor;
            $this->antialiasing = $oImage->antialiasing;
            $this->resampling = $oImage->resampling;
            $this->weight = $oImage->weight;
            $this->roundedPrimitives = $oImage->roundedPrimitives;
            $this->figureFill = $oImage->figureFill;
            $this->figureOutline = $oImage->figureOutline;
        }
    }
