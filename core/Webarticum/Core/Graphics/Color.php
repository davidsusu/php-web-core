...
class Color {
    ...
    /**
     * @param \Webarticum\Core\Graphics\Color|string|array|int $param1
     * @param int $param2
     * @param int $param3
     * @param int $param4
     */
     ...
     *
     * @param \Webarticum\Core\Graphics\Color $oColor
     * @return boolean
     */
     ...
     * @return self
     */
    public function gamma($power) {
        return new Color(
            pow($this->red / 255, $power) * 255,
            pow($this->green / 255, $power) * 255,
            pow($this->blue / 255, $power) * 255,
            $this->alpha
        );
    }
